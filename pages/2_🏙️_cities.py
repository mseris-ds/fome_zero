...
def top10_cities_restaurants( df ):
...
def top7_cities_best_restaurants( df ):
...
with st.container():
    ...
    fig = top10_cities_restaurants( df )
...
with st.container():
    ...
    with col1:
        ...
        fig = top7_cities_best_restaurants( df )
        st.plotly_chart(fig, use_container_width = True)

    with col2:
        
        fig = top7_worst_restaurants( df )        
        st.plotly_chart(fig, use_container_width = True)

with st.container():

    fig = top10_cities_cuisines( df )
    st.plotly_chart(fig, use_container_width = True)
